...
var RemoveMyMasterComponent = /** @class */ (function () {
    ...
    RemoveMyMasterComponent = __decorate([
        core_1.Component({
            ...
            templateUrl: './remove-my-master.component.html',
            styleUrls: ['./remove-my-master.component.css']
        }),
        __metadata("design:paramtypes", [])
    ], RemoveMyMasterComponent);
    return RemoveMyMasterComponent;
}());
exports.RemoveMyMasterComponent = RemoveMyMasterComponent;
//# sourceMappingURL=remove-my-master.component.js.map